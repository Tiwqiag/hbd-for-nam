...
<html lang="en">
  ...
  <body>
    <div class="wrapper">
      ...
      <div class="content">
        <header>
          <h2 id="text3">22H30 ra ngoài công viên t ngồi đợi làm sn ý nha ._.</h2>
          <h4 id="text4">
            Nếu cậu ko trả lời mà thoát ra là t gọi cháy máy lun á :v
          </h4>
        </header>
        <button id="yes" type="button" class="btn btn-danger btn-lg">
          Không ra cũng phải ra <333
        </button>
